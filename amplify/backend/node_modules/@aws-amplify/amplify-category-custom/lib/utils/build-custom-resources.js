...
const generateDependentResourcesType = async (context) => {
    ...
    const copyJobs = [
        {
            ...
            target: path.join(resourceDirPath, constants_1.AMPLIFY_RESOURCES_TYPE_DEF_FILENAME),
        },
    ];
    const allResources = (0, dependency_management_utils_1.getAllResources)();
    const params = {
...
const buildResource = async (context, resource) => {
    ...
    await (0, exports.generateDependentResourcesType)(context);
