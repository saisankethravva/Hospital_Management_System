...
export declare type ModelFieldMap = {
...
export declare type ResolverReferenceEntry = {
    typeName: string;
    fieldName: string;
    isList: boolean;
};
export declare type FieldMapEntry = {
    originalFieldName: string;
    currentFieldName: string;
};
export declare type ReadonlyArray<T> = Readonly<Array<Readonly<T>>>;
