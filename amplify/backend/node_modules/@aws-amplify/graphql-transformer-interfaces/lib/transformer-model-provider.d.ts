...
export declare type TransformerAuthProvider = TransformerPluginProvider;
export declare type TransformerModelEnhancementProvider = Partial<TransformerModelProvider>;
