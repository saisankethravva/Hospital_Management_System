                ...
                if (!valid && schemaValidate.errors) {
                    ...
                    if (unknownFlags.length > 0 || otherErrors.length > 0) {
                        throw new amplify_error_1.AmplifyError('FeatureFlagsValidationError', {
                            ...
                            details: (unknownFlags.length > 0 ? `These feature flags are defined in the "amplify/cli.json" configuration file and are unknown to the currently running Amplify CLI:\n${unknownFlags.map(el => `- ${el}`).join(',\n')}\n` : '')
